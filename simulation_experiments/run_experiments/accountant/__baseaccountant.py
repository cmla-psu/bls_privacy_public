...
class BaseAccountant(ABC):
    ...
    def answer_identity_query_using_standgaus(self, mu_dict, name="Identity"):
        ...
        if len(agg_cols) == 0:
            return
        answer = mechanisms.standard_gaussian_mech(self.__prng, self.__reader.df, group_cols,
    ...
    def answer_groupby_query_using_standgaus(self, group_cols, mu_dict, name=None):
