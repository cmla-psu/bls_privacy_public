...
def combine_qwi_cbp(rawfile, imputedfile,qwifolder,outfilename="combineQWIandCBP.csv",printdiagnostics=False,outfilepath="PythonPreprocessOut"):
    ...
    misscount = sum(combinedf['_merge'] == "left_only")
    ...
    if printdiagnostics:
        with open(outfilepath+'diagnosticsCombines.txt','w') as f:
            ...
            print("Number of rows in CBP but not QWI: ", misscount, file=f)
...
foldername = "storage/home/krd5520/work/GetSynDataFromQWIandCBP/DataIn/"
combine_qwi_cbp(foldername+"CBPdataRAW/cbp16co.txt",
                foldername+"ImputeCBP/efsy_cbp_2016.csv",
                foldername+"QWIdata/",printdiagnostics=True,
               outfilepath=foldername+"PythonPreprocessOut/")
